...
# A jail has N prisoners, and each prisoner has a unique id number, S, ranging 
...
# picks prisoner S = 2, then his distribution order would be (2, 3, 4, 5,...,
# n - 1, n, 1, 2, 3, 4,...) until all M sweets are distributed.
#
...
# N (the number of prisoners), M (the number of sweets), and S (the prisoner 
# ID), respectively.
#
# Constraints
#
